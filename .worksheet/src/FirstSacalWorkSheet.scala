object FirstSacalWorkSheet {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(73); 
  ...
  sqrt(1e60);System.out.println("""res3: Double = """ + $show(res$3));$skip(9); val res$4 = 
	sqrt(5);System.out.println("""res4: Double = """ + $show(res$4))}
}